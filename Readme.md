...
<img
  ...
  <p align="left">
    Soy estudiante de Ing. de Sistemas | Estudiante de Desarrollo FullStack Java en Generación Colombia | Full Stack Developer con JavaScript en Platzi, tecnólogo en
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- |
| Tecnlg. GRD <br><img src="[[[https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Sena_Colombia_logo.svg/2090px-Sena_Colombia_logo.svg.png]](https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Sena_Colombia_logo.svg/1280px-Sena_Colombia_logo.svg.png)](https://bogota.gov.co/sites/default/files/inline-images/logosena.png)" width="50px" height="50px"/>    | Full Stack Developer <br><img src="https://static.platzi.com/static/images/footer/logo.png" width="130px" height="50px"/>                                    | Español |
| Téc. Sistemas <br> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Sena_Colombia_logo.svg/2090px-Sena_Colombia_logo.svg.png" width="50px" height="50px"/> |  Generación Colombia <br><img src="https://colombia.generation.org/wp-content/uploads/2021/09/Generation_Colombia_logo_NEW-BLUE.svg" width="150px" height="40px"/> | Inglés  |
|                                                                                                                                                                               | Producción Musical <br> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQa99PrS_Oi0vH2s2hlPvHzG84pI0DxMdHcRw&s" width="100px" height="40px"/>                      |
